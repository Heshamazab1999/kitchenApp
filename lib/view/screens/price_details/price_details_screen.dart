...
class PriceDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(PriceDetailsController());
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(() => CustomRowTextField(
                            label: "الاسم",
                            errorLabel: controller.name.error,
                      ...
                      CustomRowTextField(
                        ...
                        errorLabel: controller.phone.error,
                        onChange: (value) {
                      ...
                      CustomButton(
                          onPressed: () async {
                            await controller.addClient(context);
                          },
                          buttonText: "اضافه",
                          radius: 9,
                      ...
                      Obx(() => controller.loading.value == false
                          ? Column(
                              children: [
                                  ...
                                  children: [
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "الجرانيت",
                                              type: controller
                                                  .garanetSelected.value,
                                              list: controller.granetList,
                                              onchange: (value) {
                                                controller.garanetSelected
                                                    .value = value!;
                                              },
                                            ))),
                                    AppDimensions.space(Dimensions.heightSmall)
                                  ...
                                  children: [
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "البانيل",
                                              type: controller
                                                  .pannelSelected.value,
                                              list: controller.pannelList,
                                              onchange: (value) {
                                                controller.pannelSelected
                                                    .value = value!;
                                              },
                                            ))),
                                    AppDimensions.space(Dimensions.heightSmall)
                                  ...
                                  children: [
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "الكورنيش",
                                              type: controller
                                                  .cornashSelected.value,
                                              list: controller.cornashList,
                                              onchange: (value) {
                                                controller.cornashSelected
                                                    .value = value!;
                                              },
                                            ))),
                                    AppDimensions.space(Dimensions.heightSmall)
                                  ...
                                  children: [
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              ...
                                              onchange: (value) {
                                                controller.maglaSelected.value =
                                                    value!;
                                                controller.items.add(Items(
                                                  itemTypeId: 4,
                                                  // categoryId: controller
                                    ...
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "حفره المجلى",
                                              type: controller
                                                  .maglaHoleSelected.value,
                                              list: controller.maglaHoleList,
                                              onchange: (value) {
                                                controller.maglaHoleSelected
                                                    .value = value!;
                                                controller.items.add(Items(
                                                  itemTypeId: 4,
                                                  // categoryId: controller
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "شفاط",
                                              type: controller
                                                  .shafatSelected.value,
                                              list: controller.shafatList,
                                              onchange: (value) {
                                                controller.shafatSelected
                                                    .value = value!;
                                                controller.items.add(Items(
                                                  itemTypeId: 4,
                                                  // categoryId: controller
                                  ...
                                  children: [
                                    Expanded(
                                        child: Obx(() => DropDownWidget(
                                              label: "البطارية",
                                              type: controller
                                                  .batterySelected.value,
                                              list: controller.batteryList,
                                              onchange: (value) {
                                                controller.batterySelected
                                                    .value = value!;
                                                controller.items.add(Items(
                                                  itemTypeId: 4,
                                                  // categoryId: controller
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          controller.itemsUnites.add(Items(
                                            ...
                                            itemTypeId: 1,
                                            categoryId: controller
                                                .unitsSelected.value.statusId,
                                            itemId: controller
                                                .unitSelected.value.statusId,
                                          ));
                                ...
                                Obx(() => Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: CustomDropDown(
                                            type: controller
                                                .accessioresSelected.value,
                                            list: controller.accessioresList,
                                            onchange: (value) {
                                              controller.accessioresSelected
                                                  .value = value!;
                                            },
                                          ),
                                        ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                        child: CustomRowTextField(
                                      controller:
                                          controller.priceAccessioresController,
                                      label: "السعر",
                                      onChange: (v) {
                                ...
                                CustomRowTextField(
                                    controller:
                                        controller.notesAccessioresController,
                                    label: "ملاحظات",
                                    onChange: (v) {
                                        ...
                                        onTap: () {
                                          controller.itemsAccessiores.add(Items(
                                            itemCount: controller
                                                .numberAccessiores.value,
                                            itemPrice: controller
                                                .priceAccessiores.value
                                                .toInt(),
                                            notes: controller
                                                .notesAccessiores.value,
                                            itemTypeId: 3,
                                            // categoryId: controller.data?.data
                                          ...
                                          controller.notesAccessioresController
                                              .clear();
                                          controller.numberAccessioresController
                                              .clear();
                                        },
                                        child: Text("إضافة؟",
                                            style: cairoRegular.copyWith(
                                ...
                                CustomButton(
                                  width: AppDimensions.space(
                                      Dimensions.PADDING_SIZE_SMALL),
                                  onPressed: () {
                                    controller.addClientFile(context);
                                  },
                                  buttonText: "اضافه",
                                ),
                                const SizedBox(
